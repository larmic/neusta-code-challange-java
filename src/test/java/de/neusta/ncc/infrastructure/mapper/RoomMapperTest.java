...
public class RoomMapperTest {
    ...
    public void mapToDto() {
        final Person person1 = new Person.PersonBuilder("Leif", "Genzmer", "lgenzmer")
                .title(PersonTitle.DR)
                .secondFirstName("Arne")
                .build();
        final Person person2 = new Person.PersonBuilder("Samin", "Ölker", "soelker")
                .addition(PersonAddition.DE)
                .build();

        final Room room = new Room.RoomBuilder("1103")
